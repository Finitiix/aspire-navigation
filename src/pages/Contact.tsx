                ...
                <Card className="p-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@achievementhub.com</p>
                      <p className="text-gray-600">support@achievementhub.com</p>
                    </div>
                  </div>
                </Card>
                <Card className="p-4">
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="container mx-auto">
          ...
          <div className="bg-gray-300 h-96 rounded-lg overflow-hidden">
            {/* Placeholder for map - in a real application, you'd embed a Google Map or similar */}
