  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        {/* Important Messages Section - Modified to have dynamic height based on content */}
        ...
        {/* Add Achievement Button & Important Details - Dynamic height */}
        <div className="flex flex-col gap-6">
          ...
          {/* Important Details Section - Modified to have dynamic height */}
          <Card className="shadow-md hover:shadow-lg transition-all duration-300 flex-1">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <div className="bg-red-100 p-1.5 rounded-full">
                  <Clock className="w-5 h-5 text-red-500" />
